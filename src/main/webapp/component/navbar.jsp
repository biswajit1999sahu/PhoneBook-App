...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand" href="index.jsp"><i class="fas fa-phone-square"></i> PhoneBook</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="addContact.jsp"><i class="fas fa-plus-square"></i> Add Phone No</a>
      </li>
    ...
    {%>
      ...
      <a href="register.jsp" class="btn btn-danger ml-2"><i class="fas fa-user"></i> Register</a>
    </form>
   <%  
   }else{%>
	   <form class="form-inline my-2 my-lg-0">
